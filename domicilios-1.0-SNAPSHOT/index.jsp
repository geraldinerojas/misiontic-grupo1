        ...
        <div class="container-fluid" ng-app="domicilios" ng-controller="controladorProductos">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div id="alertaActualizar"></div>
                    <div id="alertaGuardar"></div>
                    <div id="alertaNoEliminar"></div>
                    <div id="alertaNoActualizar"></div>
                    <div id="alertaNoGuardar"></div>
                    <div id="alertaNoListar"></div>
...
<script src="ctrllor-Productos.js"></script>
</html>
